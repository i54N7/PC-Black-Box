...
class PCBlackBox(tk.Tk):
    ...
    def build_settings(self):
        ...
        self.label(
            note,
            "The app never invents missing sensor values. If a CPU/GPU temperature is not exposed, it is shown as N/A.",
    ...
    def start_bridge(self):
        ...
        try:
            ...
            self.bridge_status_var.set("Hardware Bridge started ✓")
